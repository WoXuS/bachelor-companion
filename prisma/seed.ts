...
async function main() {
    ...
    const items = [
        { key: 'immunity', label: 'Immunitet (nikt Ci nie przeszkadza do końca mini-gry)', cost: 8, category: 'immunitet' },
        { key: 'give-shot', label: 'Każ komuś wypić szota', cost: 5, category: 'trolling' },
        { key: 'swimming-googles', label: 'Wyznaczasz kogoś do chodzenia w okularach do pływania przez 10 minut', cost: 6, category: 'trolling' },
