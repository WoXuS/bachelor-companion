...
export default function VirtualEggButton({
    ...
    return <ActiveVirtualEggButton id={data.id} placementKey={placementKey} imgSrc={imgSrc} size={size}
                                   className={className}/>
}

function ActiveVirtualEggButton({
                                    id,
                                    imgSrc = '/images/easter-egg.png',
                                    size = 24,
                                    className = 'opacity-60 hover:opacity-100 transition-opacity cursor-pointer',
                ...
                {eggLoading ? (
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <Button onClick={() => selected && claimMut.mutate()}
